...
public class ChatService extends Service implements IChatService {
    ...
    public void onCreate() {
        ...
        sendThread.start();
        Looper looper = sendThread.getLooper();
    ...
    public void send(InetAddress destAddress, int destPort,
        ...
        data.putByteArray(SendHandler.HDLR_DEST_ADDRESS, destAddress.getAddress());
        data.putInt(SendHandler.HDLR_DEST_PORT, destPort);
    ...
    private final class SendHandler extends Handler {
        ...
        public void handleMessage(android.os.Message message) {
            ...
            try {
                ...
                //Log.i(TAG, data.(HDLR_DEST_ADDRESS));
                destAddr = InetAddress.getByAddress(data.getByteArray(HDLR_DEST_ADDRESS));
                ...
                Log.d(TAG, "Current thread before persist "+Thread.currentThread());
