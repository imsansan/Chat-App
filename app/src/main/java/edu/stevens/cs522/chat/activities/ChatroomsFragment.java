...
public class ChatroomsFragment extends Fragment implements View.OnClickListener, TextAdapter.OnItemClickListener<Chatroom> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        chatroomsAdapter = new TextAdapter<Chatroom>(chatroomList, this::onItemClick);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        //initialize the chatroom view model
        ...
        LiveData<List<Chatroom>> chatroomList = chatroomViewModel.fetchAllChatrooms();
        chatroomList.observe( requireActivity(),
                ms ->{
                    if (ms != null){
    ...
    public void onClick(View v) {
        ...
        // request the activity to add the chatroom to the database
    ...
    public void onItemClick(RecyclerView parent, View view, int position, Chatroom chatroom) {
        ...
        // ask the activity to respond to the selection (in single-pane layout, it will push detail fragment)
